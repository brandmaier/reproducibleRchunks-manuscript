...
jsonlite::serializeJSON(numbers_ex, pretty=TRUE)
```
...
```{r echo=FALSE, eval=TRUE, results="asis"}
jsonlite::serializeJSON(digest::digest(numbers_ex,algo = "sha256"),pretty=TRUE)
```
...
This is shown in the schematic in Figure \@ref(ref:jsonschema).
