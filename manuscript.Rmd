...
Among information relevant to reproducibility issues, its `output` attribute also contains timing variables `wallTime` and `cpuTime`, which will almost always lead to a non-reproducibility error if the entire `factorFit1` object is tested for reproducibility:
