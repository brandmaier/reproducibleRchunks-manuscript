...
R Markdown is a simple language, which allows mixing natural language, simple formatting instructions (e.g., what is a headline, what should appear in bold face, or what are list elements) and computer code (R, Python, or others) in a single document [@xie2018r].
...
further, R Markdown is versatile enough to generate a variety of scientific assets beyond manuscripts, including posters [@posterdown2019], presentations [@xaringan2022], resumés [@vitae2023] or preregistrations [@peikert2021reproducible], all using the same Markdown approach.
...
Following this, we provide more detailed technical background information about the package and various ways to customize its behavior.
...
Yet, a particular advantage of using `reproducibleR` chunks is that users have a fine-grained control over what should be tested for reproducibility and at what stages during the data analysis.
